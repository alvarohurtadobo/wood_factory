...
class MyDrawer extends StatelessWidget {
      ...
      child: SafeArea(
        child: ListView(
          children: [
            ...
            drawerTile(context, Icons.home, "Inicio",
                "Ventana principal",
                route: "/home"),
            drawerTile(context, Icons.person, "Mi Perfil",
                "Actualiza tu información",
                route: "/profile"),
            drawerTile(context, Icons.search, "Búsqueda",
    ...
    return GestureDetector(
      ...
      child: Container(
          padding: EdgeInsets.symmetric(
              vertical: Sizes.padding, horizontal: Sizes.padding),
  ...
  Widget logoutTile(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
          padding: EdgeInsets.symmetric(
              vertical: Sizes.padding + 3.5, horizontal: Sizes.padding),
          // margin: EdgeInsets.symmetric(horizontal: Sizes.padding),
          decoration: const BoxDecoration(
              color: Colors.white,
              border: Border(bottom: BorderSide(color: Color(0xffB1B2B3)))),
